...
function sessionPayload() {
  // Alert labels (container, pod, job, …) are flattened into context so that
  // RAG template placeholders like {{namespace}}, {{container}} are substituted
  // automatically without the user having to provide them manually.
